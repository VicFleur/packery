...
(function (window, factory) {
    ...
    proto.measureNearestCornerDistance = function (spaces) {
        if (!this.center) {
            return;
        }
        ...
        for (var i = 0, len = spaces.length; i < len; i++) {
            ...
            space.nearestCornerDistance = this.getDistance(corner, this.center);
        }
    };
    ...
    proto.getDistance = function (pointA, pointB) {
